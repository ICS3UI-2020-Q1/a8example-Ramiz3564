...
public class Main implements Runnable, ActionListener{
  ...
  public void run(){
    ...
    //intilaize the input text field 
    ...
    //set size and location of text areas
